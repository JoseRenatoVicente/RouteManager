...
public sealed class UploadExcelFileCommandHandler : ICommandHandler<UploadExcelFileCommand>
{
    private readonly IExcelFileRepository _excelFileRepository;

    public UploadExcelFileCommandHandler(IExcelFileRepository excelFileRepository)
    {
        _excelFileRepository = excelFileRepository;
    }

    public async Task<Response> Handle(UploadExcelFileCommand request, CancellationToken cancellationToken)
    {
